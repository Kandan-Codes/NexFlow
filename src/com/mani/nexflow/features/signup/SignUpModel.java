...
class SignUpModel {
    ...
    List<Employee> getActiveManagers() {
        return NexFlowDB.getInstance().getActiveManagers();
    }

    void registerEmployee(String name, String email, String accessKey, String mobile, Long dob, Employee.Role role, Long reportingTo) {
